...
''' generatore di accordi per tutte le tonalità
...
chord_dict = {
    ...
    "Do min7b5": ["Do", "Mib", "Solb", "Sib"],
    "Do dim7": ["Do", "Mib", "Solb", "La"],
    "Do7sus4": ["Do", "Fa", "Sol", "Sib"],
    "Do7#5": ["Do", "Mi", "Sol#", "Sib"],
    "Do7b5": ["Do", "Mi", "Solb", "Sib"],
    "Do9": ["Do", "Mi", "Sol", "Sib", "Re"],
    "Do min9": ["Do", "Mib", "Sol", "Sib", "Re"],
    "Do maj9": ["Do", "Mi", "Sol", "Si", "Re"],
    "Do11": ["Do", "Mi", "Sol", "Sib", "Re", "Fa"],
    "Do maj11": ["Do", "Mi", "Sol", "Si", "Re", "Fa"],
    "Do13": ["Do", "Mi", "Sol", "Sib", "Re", "Fa", "La"],
    "Do maj13": ["Do", "Mi", "Sol", "Si", "Re", "Fa", "La"],
    "Do7#9": ["Do", "Mi", "Sol", "Sib", "Re#"],
    "Do7b9": ["Do", "Mi", "Sol", "Sib", "Reb"],
    "Do7#5#9": ["Do", "Mi", "Sol#", "Sib", "Re#"],
    "Do7b5b9": ["Do", "Mi", "Solb", "Sib", "Reb"],
    "Do6": ["Do", "Mi", "Sol", "La"],
    "Do min6": ["Do", "Mib", "Sol", "La"],
    "Do6/9": ["Do", "Mi", "Sol", "La", "Re"],
    "Do min6/9": ["Do", "Mib", "Sol", "La", "Re"],
    "Do sus2": ["Do", "Re", "Sol"],
    "Do sus4": ["Do", "Fa", "Sol"],
    "Do add9": ["Do", "Mi", "Sol", "Re"],
    "Do min add9": ["Do", "Mib", "Sol", "Re"],
    "Do add11": ["Do", "Mi", "Sol", "Fa"],
    "Do min add11": ["Do", "Mib", "Sol", "Fa"],
    "Do quartale": ["Do", "Fa", "Sib"],
    "Do quintale": ["Do", "Sol", "Re"]
}

# Generazione per tutte le tonalità
notes = ["Do", "Do#", "Re", "Mib", "Mi", "Fa", "Fa#", "Sol", "Sol#", "La", "Sib", "Si"]
chord_variants = list(chord_dict.keys())

global_chords = {}
for note in notes:
    for chord in chord_variants:
        if chord.startswith("Do"):
            new_chord = chord.replace("Do", note, 1)
            new_notes = [n.replace("Do", note, 1).replace("Mib", "Re#").replace("Sib", "La#") for n in chord_dict[chord]]
            global_chords[new_chord] = new_notes
...
##################
### Nella Parte RITMO ###
# import music21: libreria per una migliore suddivisione metrica futura
##################
...
# Le 5 funzioni di seguito hanno il semplice compito di mostrare i dati (liste, dizionari) a seconda degli input suggeriti all'utente.
# viene Mostrato il Database completo1
...
def chiediscala_ottieninote():
    ...
    for k, v in scale.items():
        if chiediscala in k:
            scalaxutente.append(v)

    else:
        print('\nLa scala non è presente\n')

    print(f'\n{chiediscala}:\n')
    for x in scalaxutente:
        print(f'{','.join(x)}\n')
...
def chiedinote_ottieniaccordi():
    ...
    chiedinotxacc = input("Inserisci le note separate da virgola:\n").strip().title().split(',')
...
def chiediaccordi_ottieninote():
    ...
    print('Dimmi uno o più accordi separati da uno spazio, ne recupererò le note:')
...
def chieditonalità_ottieniaccordi():
    ...
    print('Usa questa notazione: *NOTA* *DESCRIZIONE*\n')
    print('Queste sono le NOTE disponibili: "Do", "Do#/Reb", "Re", "Re#/Mib", "Mi", "Fa", "Fa#/Solb", "Sol", "Sol#/Lab", "La", "La#/Sib", "Si"')
    print('Queste sono le DESCRIZIONI disponibili: Maggiore, Minore, Minore armonica, Minore Melodica\n\n')
    
    sceglitonalità = input('scegli una tonalità ti mostro gli accordi connessi(Do Maggiore, Sib Minore):\n').strip().title()
...
def chiediaccordi_ottienitonalita():
    ...
    chords = input("Inserisci fino a 4 accordi, separati da una virgola, ti dirò a quale tonalità appartengono:\n").strip()
